    ...
    <div className="flex flex-col gap-4 w-full">
      ...
      {sortedRelated.length > 0 && (
        <div className="bg-surface-card rounded-lg shadow-card border border-surface-divider/30 overflow-hidden font-myungjo pl-2">
          <div className="bg-surface-main/50 py-3 px-6 border-b border-surface-divider/30 flex items-center justify-between">
            <h4 className="text-14 font-bold text-text-primary m-0 flex-1">연관 키워드</h4>
            <div className="hidden sm:flex items-center gap-4 text-12 text-text-secondary pr-2 mr-36">
              <span className="w-28 text-right">검색량 추정치</span>
